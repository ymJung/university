...
public class Sha512 {
	 ...
	 private long h0, h1, h2, h3, h4, h5, h6, h7; //h
	...
	//패딩
	 ...
	 protected void resetContext() //초기 상수값
	 {
	 ...
	 private static final synchronized long[] sha(long hh0, long hh1, long hh2,
             long hh3, long hh4, long hh5, long hh6, long hh7, byte[] in, int offset)
	 {
	     long A = hh0;
	     long B = hh1;
	     long C = hh2;
	     ...
	     for (r = 0; r < 16; r++) // 있는 그대로의 값 복사 & 연산자 사용
	     {
	     ...
	     for (r = 16; r < 80; r++) //16부터 80까지 워드 확장
	     {
	         T = w[r - 2]; 
	         T2 = w[r - 15];
	 ...
	 public static void main(String[] args){
		 System.out.println("Sha512해쉬 시킬 문자열 입력");
		 ...
		 Sha512 q = new Sha512();
		 q.Sha512()
		 //String outputtext = Long.toString(val);
